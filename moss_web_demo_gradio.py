...
shutil.copyfile('../moss-moon-003-sft-int4/custom_autotune.py', '/root/.cache/huggingface/modules/transformers_modules/local/custom_autotune.py')

parser = argparse.ArgumentParser()
parser.add_argument("--model_name", default="fnlp/moss-moon-003-sft-int4", type=str)
